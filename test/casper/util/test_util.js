...
var SELECTORS = {
  ...
  pluginTypeDropdown:
    '#modal_overlay #setting-value-container-plugin-types select',
  ...
  autofillDatasource:
    '#modal_overlay #setting-value-container-value li i.icon-plus',
...
function clickModalOK(test) {
  casper.then(function () {
    ...
    casper.on('click', SELECTORS.modalOK);
...
exports.addJSONDatasource = function (test, name, url) {
  casper.then(function () {
    ...
    casper.on('click', SELECTORS.addDatasource);
